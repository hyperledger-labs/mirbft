...
type Actions struct {
	...
	Send              []*ActionSend        `protobuf:"bytes,1,rep,name=send,proto3" json:"send,omitempty"`
	Hash              []*ActionHashRequest `protobuf:"bytes,2,rep,name=hash,proto3" json:"hash,omitempty"`
	WriteAhead        []*ActionWrite       `protobuf:"bytes,3,rep,name=write_ahead,json=writeAhead,proto3" json:"write_ahead,omitempty"`
	Commits           []*ActionCommit      `protobuf:"bytes,4,rep,name=commits,proto3" json:"commits,omitempty"`
	AllocatedRequests []*ActionRequestSlot `protobuf:"bytes,5,rep,name=allocated_requests,json=allocatedRequests,proto3" json:"allocated_requests,omitempty"`
	CorrectRequests   []*msgs.RequestAck   `protobuf:"bytes,6,rep,name=correct_requests,json=correctRequests,proto3" json:"correct_requests,omitempty"`
	ForwardRequests   []*ActionForward     `protobuf:"bytes,7,rep,name=forward_requests,json=forwardRequests,proto3" json:"forward_requests,omitempty"`
	StateTransfer     *ActionStateTarget   `protobuf:"bytes,8,opt,name=state_transfer,json=stateTransfer,proto3" json:"state_transfer,omitempty"`
}
...
func (x *Actions) GetSend() []*ActionSend {
	if x != nil {
		return x.Send
	}
	return nil
...
func (x *Actions) GetHash() []*ActionHashRequest {
	if x != nil {
		return x.Hash
	}
	return nil
...
func (x *Actions) GetWriteAhead() []*ActionWrite {
	if x != nil {
		return x.WriteAhead
	}
	return nil
...
func (x *Actions) GetCommits() []*ActionCommit {
	if x != nil {
		return x.Commits
	}
	return nil
...
func (x *Actions) GetAllocatedRequests() []*ActionRequestSlot {
	if x != nil {
...
func (x *Actions) GetCorrectRequests() []*msgs.RequestAck {
	if x != nil {
...
func (x *Actions) GetForwardRequests() []*ActionForward {
	if x != nil {
...
func (x *Actions) GetStateTransfer() *ActionStateTarget {
	if x != nil {
...
func (x *ActionCommit) GetSeqNo() uint64 {
	if x != nil {
		return x.SeqNo
	}
	return 0
...
func (x *ActionCommit) GetNetworkConfig() *msgs.NetworkState_Config {
	if x != nil {
...
func (x *ActionCommit) GetClientStates() []*msgs.NetworkState_Client {
	if x != nil {
...
func (*HashResult_Batch) Descriptor() ([]byte, []int) {
	return file_state_state_proto_rawDescGZIP(), []int{17, 0}
}
...
func (*HashResult_VerifyBatch) Descriptor() ([]byte, []int) {
	return file_state_state_proto_rawDescGZIP(), []int{17, 1}
}
...
func (*HashResult_EpochChange) Descriptor() ([]byte, []int) {
	return file_state_state_proto_rawDescGZIP(), []int{17, 2}
}
...
var file_state_state_proto_rawDesc = []byte{
	...
	,
	...
	,
...
var file_state_state_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_state_state_proto_goTypes = []interface{}{
	...
	(*Actions)(nil),                  // 9: state.Actions
	(*ActionSend)(nil),               // 10: state.ActionSend
	(*ActionWrite)(nil),              // 11: state.ActionWrite
	(*ActionCommit)(nil),             // 12: state.ActionCommit
	(*ActionRequestSlot)(nil),        // 13: state.ActionRequestSlot
	(*ActionForward)(nil),            // 14: state.ActionForward
	(*ActionHashRequest)(nil),        // 15: state.ActionHashRequest
	(*ActionStateTarget)(nil),        // 16: state.ActionStateTarget
	(*HashResult)(nil),               // 17: state.HashResult
	(*CheckpointResult)(nil),         // 18: state.CheckpointResult
	(*HashResult_Batch)(nil),         // 19: state.HashResult.Batch
	(*HashResult_VerifyBatch)(nil),   // 20: state.HashResult.VerifyBatch
	(*HashResult_EpochChange)(nil),   // 21: state.HashResult.EpochChange
	(*msgs.CEntry)(nil),              // 22: msgs.CEntry
	(*msgs.Persistent)(nil),          // 23: msgs.Persistent
	(*msgs.RequestAck)(nil),          // 24: msgs.RequestAck
	(*msgs.Msg)(nil),                 // 25: msgs.Msg
	(*msgs.QEntry)(nil),              // 26: msgs.QEntry
	(*msgs.NetworkState_Config)(nil), // 27: msgs.NetworkState.Config
	(*msgs.NetworkState_Client)(nil), // 28: msgs.NetworkState.Client
	(*msgs.NetworkState)(nil),        // 29: msgs.NetworkState
	(*msgs.EpochChange)(nil),         // 30: msgs.EpochChange
}
var file_state_state_proto_depIdxs = []int32{
	...
	22, // 5: state.Event.Transfer:type_name -> msgs.CEntry
	...
	23, // 10: state.EventPersistedEntry.data:type_name -> msgs.Persistent
	17, // 11: state.EventActionResults.digests:type_name -> state.HashResult
	18, // 12: state.EventActionResults.checkpoints:type_name -> state.CheckpointResult
	24, // 13: state.EventClientActionResults.persisted:type_name -> msgs.RequestAck
	25, // 14: state.EventInboundMsg.msg:type_name -> msgs.Msg
	10, // 15: state.Actions.send:type_name -> state.ActionSend
	15, // 16: state.Actions.hash:type_name -> state.ActionHashRequest
	11, // 17: state.Actions.write_ahead:type_name -> state.ActionWrite
	12, // 18: state.Actions.commits:type_name -> state.ActionCommit
	13, // 19: state.Actions.allocated_requests:type_name -> state.ActionRequestSlot
	24, // 20: state.Actions.correct_requests:type_name -> msgs.RequestAck
	14, // 21: state.Actions.forward_requests:type_name -> state.ActionForward
	16, // 22: state.Actions.state_transfer:type_name -> state.ActionStateTarget
	25, // 23: state.ActionSend.msg:type_name -> msgs.Msg
	23, // 24: state.ActionWrite.data:type_name -> msgs.Persistent
	26, // 25: state.ActionCommit.batch:type_name -> msgs.QEntry
	27, // 26: state.ActionCommit.network_config:type_name -> msgs.NetworkState.Config
	28, // 27: state.ActionCommit.client_states:type_name -> msgs.NetworkState.Client
	24, // 28: state.ActionForward.ack:type_name -> msgs.RequestAck
	17, // 29: state.ActionHashRequest.origin:type_name -> state.HashResult
	19, // 30: state.HashResult.batch:type_name -> state.HashResult.Batch
	21, // 31: state.HashResult.epoch_change:type_name -> state.HashResult.EpochChange
	20, // 32: state.HashResult.verify_batch:type_name -> state.HashResult.VerifyBatch
	29, // 33: state.CheckpointResult.network_state:type_name -> msgs.NetworkState
	24, // 34: state.HashResult.Batch.request_acks:type_name -> msgs.RequestAck
	24, // 35: state.HashResult.VerifyBatch.request_acks:type_name -> msgs.RequestAck
	30, // 36: state.HashResult.EpochChange.epoch_change:type_name -> msgs.EpochChange
...
func file_state_state_proto_init() {
	...
	file_state_state_proto_msgTypes[17].OneofWrappers = []interface{}{
