...
func (x *Preprepare) GetRequests() []*requestpb.RequestRef {
	if x != nil {
		return x.Requests
	}
	return nil
...
var file_isspbftpb_isspbftpb_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x4f, 0x0a, 0x0a, 0x50, 0x72, 0x65, 0x70, 0x72, 0x65, 0x70, 0x61, 0x72, 0x65, 0x12,
	...
	0x0b, 0x32, 0x15, 0x2e, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x70, 0x62, 0x2e, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x65, 0x66, 0x52, 0x08, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73,
...
var file_isspbftpb_isspbftpb_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_isspbftpb_isspbftpb_proto_goTypes = []interface{}{
	(*Preprepare)(nil),           // 0: isspbftpb.Preprepare
	(*requestpb.RequestRef)(nil), // 1: requestpb.RequestRef
}
var file_isspbftpb_isspbftpb_proto_depIdxs = []int32{
	1, // 0: isspbftpb.Preprepare.requests:type_name -> requestpb.RequestRef
