...
set key fixed left top vertical Right noreverse enhanced autotitle nobox font "Helvetica,24"
# set key at -0.4, 11.8
...
set xlabel "number of Byzantine leaders"
set xlabel  font "Helvetica,28" textcolor lt -1 norotate offset 0,-1
set x2label ""
set x2label  font "" textcolor lt -1 norotate
set xrange [ 0.00000 : 5 ] noreverse writeback
...
set yrange [ 0.00000 : 16.000 ] noreverse writeback
...
GNUTERM = "wxt"
x = 0.0
plot 'censor500.data' u 1:2 w lp t '100% censoring - mean' lt -1 pt 1 lw 2 ps 2, 'censor500.data' u 1:3 w lp t '100% censoring - 95P' lt -1 pt 4 lw 2 ps 2, 'censor500.data' u 1:4 w lp t '25% censoring - mean' lt -1 pt 6 lw 2 ps 2, 'censor500.data' u 1:5 w lp t '25% censoring - 95P' lt -1 pt 5 lw 2 ps 2
# plot 'censor3500.data' u 1:2 w lp t '99% - client to f+1' lt -1 pt 1 lw 2 ps 2, 'censor3500.data' u 1:3 w lp t '99% - client to all' lt -1 pt 4 lw 2 ps 2, 'censor3500.data' u 1:4 w lp t 'mean - client to f+1' lt -1 pt 6 lw 2 ps 2, 'censor3500.data' u 1:5 w lp t 'mean - client to all' lt -1 pt 5 lw 2 ps 2
