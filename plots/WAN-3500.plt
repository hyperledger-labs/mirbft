...
set yrange [ 0.00000 : 45.000 ] noreverse writeback
...
GNUTERM = "wxt"
x = 0.0
## Last datafile plotted: "WAN.data"
plot 'WAN-Mir-3500.data' u 1:3 w lp t 'Mir (LTO, noSVS)' lt -1 pt 5 lw 2 ps 2, 'WAN-Mir-3500.data' u 1:2 w lp t 'Mir (noSVS)' lt -1 pt 4 lw 2 ps 2, 'WAN-PBFT.data' u 1:2 w lp t 'PBFT' lt -1 pt 2 lw 2 ps 2, 'WAN-Chain-HB.data' u 1:2 w lp t 'Chain' lt -1 pt 6 lw 2 ps 2
#    EOF
