...
GNUTERM = "wxt"
x = 0.0
plot 'WAN-Mir-500.data' u 1:2 w lp t 'Mir (noSVS) - 500b' lt -1 pt 4 lw 2 ps 2, 'WAN-Mir-500.data' u 1:3 w lp t 'Mir - 500b' lt -1 pt 5 lw 2 ps 2, 'WAN-PBFT.data' u 1:3 w lp t 'PBFT - 500b' lt -1 pt 2 lw 2 ps 2, 'WAN-Chain-HB.data' u 1:3 w lp t 'Chain - 500b' lt -1 pt 6 lw 2 ps 2, 'WAN-Chain-HB.data' u 1:4 w lp t 'Honeybadger - 250b' lt -1 pt 3 lw 2 ps 2
#    EOF
