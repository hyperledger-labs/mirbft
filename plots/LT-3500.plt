...
GNUTERM = "wxt"
x = 0.0
## Last datafile plotted: "PBFT-LT-3500.data"
plot 'LT-MirNoR-3500.data' u 1:2 w lp t 'Parallel PBFT' lt -1 pt 3 lw 2 ps 2, 'LT-MirLTO-3500.data' u 1:2 w lp t 'Mir (LTO, noSVS)' lt -1 pt 5 lw 2 ps 2, 'LT-Mir-3500.data' u 1:2 w lp t 'Mir (noSVS)' lt -1 pt 4 lw 2 ps 2,  'LT-Chain-3500.data' u 1:2 w lp t 'Chain' lt -1 pt 6 lw 2 ps 2, 'LT-PBFT-3500.data' u 1:2 w lp t 'PBFT' lt -1 pt 2 lw 2 ps 2
#    EOF
