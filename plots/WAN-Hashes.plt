...
set label 2 "" at 0.00000, 0.00000, 0.00000 left norotate font "Helvetica,18" back nopoint
set label 3 "" at 0.00000, 0.00000, 0.00000 left norotate font ",18" back nopoint
...
set ylabel "peak throughput (kreq/s)"
set ylabel  font "Helvetica,28" textcolor lt -1 rotate offset -7

set y2label ""
set y2label  font "" textcolor lt -1 rotate
set yrange [ 0.00000 : 180.000 ] noreverse writeback
...
GNUTERM = "wxt"
x = 0.0
## Last datafile plotted: "MirLAN500.data"
plot 'WAN-Mir-Hashes.data' u 1:2 w lp t 'Mir (hashes - w/o client auth)' lt -1 pt 1 lw 2 ps 2, 'WAN-HotStuff-Hashes.data' u 1:2 w lp t 'HotStuff (hashes - w/o client auth)' lt -1 pt 2 lw 2 ps 2
#    EOF
