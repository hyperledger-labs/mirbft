...
type StateEventResult struct {
	...
	CorrectRequests   []*RequestAck                   `protobuf:"bytes,6,rep,name=correct_requests,json=correctRequests,proto3" json:"correct_requests,omitempty"`
...
func (x *StateEventResult) GetCorrectRequests() []*RequestAck {
	if x != nil {
		return x.CorrectRequests
	}
	return nil
}
...
var file_mirbft_proto_rawDesc = []byte{
	...
	0x73, 0x12, 0x3f, 0x0a, 0x10, 0x63, 0x6f, 0x72, 0x72, 0x65, 0x63, 0x74, 0x5f, 0x72, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x69,
	0x72, 0x62, 0x66, 0x74, 0x70, 0x62, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x41, 0x63,
	0x6b, 0x52, 0x0f, 0x63, 0x6f, 0x72, 0x72, 0x65, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
...
var file_mirbft_proto_depIdxs = []int32{
	...
	15, // 58: mirbftpb.StateEventResult.correct_requests:type_name -> mirbftpb.RequestAck
