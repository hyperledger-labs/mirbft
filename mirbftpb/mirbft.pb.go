...
func (*NetworkConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{0}
}
...
func (*NetworkConfig_Client) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{0, 0}
}
...
type Persisted struct {
	...
	//	*Persisted_PEntry
	//	*Persisted_CEntry
	//	*Persisted_EpochChange
	//	*Persisted_NewEpochEcho
	//	*Persisted_NewEpochReady
	//	*Persisted_NewEpochStart
	//	*Persisted_Suspect
...
func (*Persisted) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{1}
}
...
func (*Persisted_EpochChange) isPersisted_Type() {}

func (*Persisted_NewEpochEcho) isPersisted_Type() {}

func (*Persisted_NewEpochReady) isPersisted_Type() {}

func (*Persisted_NewEpochStart) isPersisted_Type() {}

func (*Persisted_Suspect) isPersisted_Type() {}
...
func (m *Persisted) GetEpochChange() *EpochChange {
	if x, ok := m.GetType().(*Persisted_EpochChange); ok {
		return x.EpochChange
	}
	return nil
}

func (m *Persisted) GetNewEpochEcho() *NewEpochConfig {
	if x, ok := m.GetType().(*Persisted_NewEpochEcho); ok {
		return x.NewEpochEcho
	}
	return nil
}

func (m *Persisted) GetNewEpochReady() *NewEpochConfig {
	if x, ok := m.GetType().(*Persisted_NewEpochReady); ok {
		return x.NewEpochReady
	}
	return nil
}

func (m *Persisted) GetNewEpochStart() *EpochConfig {
	if x, ok := m.GetType().(*Persisted_NewEpochStart); ok {
		return x.NewEpochStart
	}
	return nil
}

func (m *Persisted) GetSuspect() *Suspect {
	if x, ok := m.GetType().(*Persisted_Suspect); ok {
		return x.Suspect
	}
	return nil
}
...
func (*Persisted) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Persisted_OneofMarshaler, _Persisted_OneofUnmarshaler, _Persisted_OneofSizer, []interface{}{
		...
		(*Persisted_EpochChange)(nil),
		(*Persisted_NewEpochEcho)(nil),
		(*Persisted_NewEpochReady)(nil),
		(*Persisted_NewEpochStart)(nil),
		(*Persisted_Suspect)(nil),
	}
}
...
func _Persisted_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 4: // type.epoch_change
		...
		msg := new(EpochChange)
		err := b.DecodeMessage(msg)
		m.Type = &Persisted_EpochChange{msg}
		return true, err
	case 5: // type.new_epoch_echo
		...
		err := b.DecodeMessage(msg)
		m.Type = &Persisted_NewEpochEcho{msg}
		return true, err
	case 6: // type.new_epoch_ready
		...
		msg := new(NewEpochConfig)
		err := b.DecodeMessage(msg)
		m.Type = &Persisted_NewEpochReady{msg}
		return true, err
	case 7: // type.new_epoch_start
		...
		msg := new(EpochConfig)
		err := b.DecodeMessage(msg)
		m.Type = &Persisted_NewEpochStart{msg}
		return true, err
	case 8: // type.suspect
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func (*QEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{2}
}
...
func (*PEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{3}
}
...
func (*CEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{4}
}
...
func (*Msg) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{5}
}
...
func (*FetchBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{6}
}
...
func (*ForwardBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{7}
}
...
func (*ForwardRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{8}
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{9}
}
...
func (*RequestAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{10}
}
...
func (*Preprepare) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{11}
}
...
func (*Prepare) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{12}
}
...
func (*Commit) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{13}
}
...
func (*Checkpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{14}
}
...
func (*Suspect) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{15}
}
...
func (*EpochChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{16}
}
...
func (*EpochChange_SetEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{16, 0}
}
...
func (*EpochChangeAck) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{17}
}
...
func (*EpochConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{18}
}
...
func (*NewEpochConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{19}
}
...
func (*NewEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{20}
}
...
func (*NewEpoch_RemoteEpochChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{20, 0}
}
...
func (*NewEpochEcho) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{21}
}
...
func (*NewEpochReady) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_818789d5e447b601, []int{22}
}
...
func init() { proto.RegisterFile("mirbft.proto", fileDescriptor_mirbft_818789d5e447b601) }

var fileDescriptor_mirbft_818789d5e447b601 = []byte{
	...
	,
}
