...
func (*Msg) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{0}
}
...
func (*Preprepare) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{1}
}
...
func (*Prepare) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{2}
}
...
func (*Commit) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{3}
}
...
func (*Checkpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{4}
}
...
func (m *Checkpoint) GetAttestation() []byte {
	if m != nil {
...
func (*Forward) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{5}
}
...
func (*Suspect) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{6}
}
...
type EpochChange struct {
	...
	BucketSets           []*EpochChange_Bucket     `protobuf:"bytes,5,rep,name=bucket_sets,json=bucketSets,proto3" json:"bucket_sets,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                  `json:"-"`
	XXX_unrecognized     []byte                    `json:"-"`
	XXX_sizecache        int32                     `json:"-"`
}
...
func (*EpochChange) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{7}
}
...
func (m *EpochChange) GetBucketSets() []*EpochChange_Bucket {
	if m != nil {
		return m.BucketSets
	}
	return nil
...
func (*EpochChange_Checkpoint) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{7, 0}
}
...
type EpochChange_Bucket struct {
	...
	// the last_checkpoint_seq_no.
	Preprepared          [][]byte `protobuf:"bytes,6,rep,name=preprepared,proto3" json:"preprepared,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *EpochChange_Bucket) Reset()         { *m = EpochChange_Bucket{} }
func (m *EpochChange_Bucket) String() string { return proto.CompactTextString(m) }
func (*EpochChange_Bucket) ProtoMessage()    {}
func (*EpochChange_Bucket) Descriptor() ([]byte, []int) {
	return fileDescriptor_mirbft_f5d9fa118893639c, []int{7, 1}
}
func (m *EpochChange_Bucket) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_EpochChange_Bucket.Unmarshal(m, b)
}
func (m *EpochChange_Bucket) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_EpochChange_Bucket.Marshal(b, m, deterministic)
}
func (dst *EpochChange_Bucket) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EpochChange_Bucket.Merge(dst, src)
}
func (m *EpochChange_Bucket) XXX_Size() int {
	return xxx_messageInfo_EpochChange_Bucket.Size(m)
}
func (m *EpochChange_Bucket) XXX_DiscardUnknown() {
	xxx_messageInfo_EpochChange_Bucket.DiscardUnknown(m)
}

var xxx_messageInfo_EpochChange_Bucket proto.InternalMessageInfo

func (m *EpochChange_Bucket) GetHighestPrepared() uint64 {
	if m != nil {
...
func (m *EpochChange_Bucket) GetPreprepared() [][]byte {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*EpochChange_Bucket)(nil), "mirbftpb.EpochChange.Bucket")
}

func init() { proto.RegisterFile("mirbft.proto", fileDescriptor_mirbft_f5d9fa118893639c) }

var fileDescriptor_mirbft_f5d9fa118893639c = []byte{
	// 518 bytes of a gzipped FileDescriptorProto
	,
}
