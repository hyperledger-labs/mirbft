...
var file_mirbft_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x73, 0x74, 0x22, 0xbd, 0x0a, 0x0a, 0x0a, 0x53, 0x74, 0x61, 0x74, 0x65, 0x45, 0x76,
	...
	0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x39, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x70, 0x6f,
	0x73, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6d, 0x69, 0x72, 0x62, 0x66,
	...
	0x73, 0x65, 0x12, 0x35, 0x0a, 0x04, 0x73, 0x74, 0x65, 0x70, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6b, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x6d, 0x69, 0x72, 0x62, 0x66, 0x74,
	...
	0x65, 0x69, 0x76, 0x65, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x6d, 0x69,
...
var file_mirbft_proto_depIdxs = []int32{
	...
	38, // 47: mirbftpb.StateEvent.propose:type_name -> mirbftpb.StateEvent.Proposal
	39, // 48: mirbftpb.StateEvent.step:type_name -> mirbftpb.StateEvent.InboundMsg
	40, // 49: mirbftpb.StateEvent.tick:type_name -> mirbftpb.StateEvent.TickElapsed
	41, // 50: mirbftpb.StateEvent.actions_received:type_name -> mirbftpb.StateEvent.Ready
	42, // 51: mirbftpb.HashResult.request:type_name -> mirbftpb.HashResult.Request
	44, // 52: mirbftpb.HashResult.batch:type_name -> mirbftpb.HashResult.Batch
	46, // 53: mirbftpb.HashResult.epoch_change:type_name -> mirbftpb.HashResult.EpochChange
	45, // 54: mirbftpb.HashResult.verify_batch:type_name -> mirbftpb.HashResult.VerifyBatch
	43, // 55: mirbftpb.HashResult.verify_request:type_name -> mirbftpb.HashResult.VerifyRequest
	0,  // 56: mirbftpb.CheckpointResult.network_state:type_name -> mirbftpb.NetworkState
	2,  // 57: mirbftpb.StateEvent.PersistedEntry.data:type_name -> mirbftpb.Persistent
	14, // 58: mirbftpb.StateEvent.OutstandingRequest.request_ack:type_name -> mirbftpb.RequestAck
	26, // 59: mirbftpb.StateEvent.ActionResults.digests:type_name -> mirbftpb.HashResult
	27, // 60: mirbftpb.StateEvent.ActionResults.checkpoints:type_name -> mirbftpb.CheckpointResult
	13, // 61: mirbftpb.StateEvent.Proposal.request:type_name -> mirbftpb.Request
	9,  // 62: mirbftpb.StateEvent.InboundMsg.msg:type_name -> mirbftpb.Msg
	13, // 63: mirbftpb.HashResult.Request.request:type_name -> mirbftpb.Request
	14, // 64: mirbftpb.HashResult.VerifyRequest.request_ack:type_name -> mirbftpb.RequestAck
	14, // 65: mirbftpb.HashResult.Batch.request_acks:type_name -> mirbftpb.RequestAck
	14, // 66: mirbftpb.HashResult.VerifyBatch.request_acks:type_name -> mirbftpb.RequestAck
	20, // 67: mirbftpb.HashResult.EpochChange.epoch_change:type_name -> mirbftpb.EpochChange
